...
start_string = remote.APIname + remote.APIversion + "   (stage:" + str(
    stage.rollout) + "/log-level:" + stage.log_level + ")"
print("----------------------------------------------------------------")
print(start_string)
print("----------------------------------------------------------------")
...
if stage.log_level == "INFO":
    stage.log_set2level = logging.INFO
elif stage.log_level == "DEBUG":
    stage.log_set2level = logging.DEBUG
elif stage.log_level == "WARN":
    stage.log_set2level = logging.WARNING
elif stage.log_level == "WARNING":
    stage.log_set2level = logging.WARNING
elif stage.log_level == "ERROR":
    stage.log_set2level = logging.ERROR
else:
    stage.log_set2level = logging.INFO
